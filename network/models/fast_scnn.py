...
__all__ = ["FastSCNN", "FastSCNNNoisyDecoders", "FastSCNNJointSegAuxDecoderModel"]
...
class FastSCNNJointSegAuxDecoderModel(nn.Module):
    ...
    def optim_parameters(self, args):
        return self.fastscnn.optim_parameters(args) + self.aux_decoders.optim_parameters(args)
...
class FastSCNN(nn.Module):
    ...
    def get_1x_lr_params_NOscale(self):
        ...
        """
        b = [
            self._md["learn_to_down"].parameters(),
            self._md["extractor"].parameters(),
            self._md["fusion"].parameters(),
        ]
    ...
    def get_10x_lr_params(self):
        ...
        """
        b = [self._md["classifier"].parameters()]
        for j in range(len(b)):
            for i in b[j]:
                yield i
